 function Card({username, btnText="visit me"}){  //default value is visit me
    ...
    return(
        <>
        <div className="md:max-w-sm w-full p-6 rounded-xl shadow-xl mt-4  bg-black border border-zinc-800 hover:border-white transition-all duration-300 hover:scale-105 group">
